...
#define DEFAULT_MINIMUMFEEDRATE       1.0 //0.0     // (mm/s. °/s for rotational-only moves) Minimum feedrate. Set with M205 S.
#define DEFAULT_MINTRAVELFEEDRATE     1.0 //0.0     // (mm/s. °/s for rotational-only moves) Minimum travel feedrate. Set with M205 T.
...
// 호스트 수신 버퍼 크기
// xon/xoff 흐름 제어가 없으면 (아래 Serial_xon_xoff 참조) 32 바이트로 충분해야합니다.
// 흐름 제어를 사용하려면이 버퍼 크기를 1024 바이트로 설정하십시오.
// : [0, 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024, 2048]
//#정의 rx_buffer_size 1024
