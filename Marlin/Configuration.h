...
* 스테퍼 드라이버
*
*이 설정을 통해 말린은 스테퍼 드라이버 타이밍을 조정하고 고급 옵션을 활성화 할 수 있습니다.
* 그들을 지원하는 스테퍼 드라이버.configuration_adv.h에서 타이밍 옵션을 무시할 수도 있습니다.
*
* TMC22225 드라이버에는 TMC2208/TMC2208_STANDALONE 및 TMC2226 드라이버의 경우 TMC2209/TMC2209_STANDALONE을 사용하십시오.
 *
...
//#define DELTA
  ...
  #define DELTA_MAX_RADIUS       360.0    // (mm)
...
#if ENABLED(POLAR)
  #define DEFAULT_SEGMENTS_PER_SECOND 180 // 180   // 움직임이 고르지 않으면이 값을 낮추십시오
  #define PRINTABLE_RADIUS 500.0f // 82.0f           // (mm) X 축의 최대 이동

  // Movements는 Polar_Fast_Radius 내부에 속합니다.
// 근거리 모션 문제와 관련된 원치 않는 증착을 보상합니다.
  #define POLAR_FAST_RADIUS 0.0f            // (mm)

  // 도구로 도달 할 수없는 반경.
// 도구가 극축의 중심에 완벽하게 정렬되지 않은 경우 필요합니다.
  #define POLAR_CENTER_OFFSET 0.0f          // (mm)

  #define FEEDRATE_SCALING                  // Convert XY feedrate from mm/s to degrees/s on the fly
  
  #define R_LINE_OFFSET 70.0f
#endif
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 800, 28.44, 200, 415 }

/**
 * 기본 최대 피드 속도 (linear=mm/s, rotational=°/s)
 * Override with M203
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 5, 1, 5, 25 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 5, 1, 100, 10000 }
...
#define CLASSIC_JERK
  ...
  #define DEFAULT_XJERK 1  //10.0
  #define DEFAULT_YJERK 1  //10.0
